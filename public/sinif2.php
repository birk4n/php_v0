...
label{
    ...
    <link href="bootstrap/css/bootstrap.min.css" rel="stylesheet">
        ...
        <script>
        var socket = io.connect('http://localhost:3000/classes');
        socket.emit("joinRoom", "sinif2");
        </script>
...
<p style="">
    ...
    if ($user) {
          echo '<div class="iframe">' ;
           ...
           echo '<iframe src="oda2.php" width="350px" height="500px" scrolling="no" frameborder="0px" ></iframe>' ;
         echo '</div>';
                    }
    else {
