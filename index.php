...
<nav class="navbar navbar-dark bg-dark navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="nav navbar-nav ml-auto">
            <?php
            if ($user) {
                echo '<li class="nav-item"><a class="nav-link" href="profil.php">Profil Bilgileri</a></li>';
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            if ($user) {
                echo '<strong> </strong>' ;
                echo '<br>';
                echo '<strong> <a href="public/sinif1.php">Veri Yapıları Sınıfı</strong> </a>';
                echo '<br>';
                echo '<strong> <a href="public/sinif2.php">Programlama Dilleri Sınıfı</strong> </a>';
